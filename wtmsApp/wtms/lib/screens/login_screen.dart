...
class _LoginScreenState extends State<LoginScreen> {
  ...
  if (response.statusCode == 200) {
    ...
    if (jsondata['status'] == 'success') {
      ...
      // write worker_id into SharedPreferences
      SharedPreferences prefs = await SharedPreferences.getInstance();
      await prefs.setString('worker_id', worker.id.toString()); // tranform to string type
      ...
      // message when successfully navigated
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Welcome ${worker.fullName}"), backgroundColor: Colors.green),
      );
